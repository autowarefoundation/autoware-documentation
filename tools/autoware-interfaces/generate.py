...
def update_type_page(pages):
    ...
    base = Path("docs/design/autoware-architecture-v1/interfaces/ad-api/types")
    ...
    for name in specs:
        ...
        text += "---\n\n"
        text += "{% extends 'design/autoware-architecture-v1/interfaces/templates/autoware-data-type.jinja2' %}\n"
    ...
    for spec in sorted(specs):
        text += f"- [{spec}](./{spec}.md)\n"
    Path("docs/design/autoware-architecture-v1/interfaces/ad-api/types/index.md").write_text(text)
...
def update_list_page(pages):
    ...
    Path("docs/design/autoware-architecture-v1/interfaces/ad-api/list/index.md").write_text(text)


def main():
    # Create a list of data types used in adapi.
    adapi = Path("docs/design/autoware-architecture-v1/interfaces/ad-api/list/api")
