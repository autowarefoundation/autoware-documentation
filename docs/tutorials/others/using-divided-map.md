...
- [The Readme of map_loader](https://github.com/autowarefoundation/autoware_core/tree/main/map/autoware_map_loader) may be useful specific instructions for dividing maps
