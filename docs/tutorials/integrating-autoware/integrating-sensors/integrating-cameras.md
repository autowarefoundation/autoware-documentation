...
For the calibration procedure, please refer to the documentation [here](../creating-vehicle-and-sensor-model/calibrating-sensors/intrinsic-camera-calibration/index.md) for more details.
