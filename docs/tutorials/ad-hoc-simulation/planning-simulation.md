...
3. Set an initial pose and a goal pose on in adjacent lanes:

   ![set-postition-and-goal](images/planning/lane-change/set-postition-and-goal.png)
   
4. Engage the ego vehicle, and it will make a lane change along the planned path.
