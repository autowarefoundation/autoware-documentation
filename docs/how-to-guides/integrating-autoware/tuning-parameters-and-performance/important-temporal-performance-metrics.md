...
<<<<<<< HEAD
| ---| --- | ---- | ---- | ------- | ------- | ------ |
| APER-001 | Message rate from CPP #2 to CPP #26 | Update rate of Traffic Light Recognition. | Perception/Traffic light Recognition | N/A It is essential to update traffic light Recognition frequently and seamlessly. | |
=======
...
> > > > > > > takam5f2/add-performance-metrics-page
