...
| OSEG-004 | **Response time** from CPS #0 to CPS #11 | Processing time to output obstacle segmentation after LiDARs output sensing data.        | Obstacle segmentation | N/A             | Planning relies on fresh and up-to-date perceived data from Obstacle segmentation. |      |
