...
Autoware requires a pointcloud map and a vector map for the vehicle's operating environment. (Check the [map design documentation page](../../design/autoware-architecture/map/index.md) for the detailed specificaiton). 
