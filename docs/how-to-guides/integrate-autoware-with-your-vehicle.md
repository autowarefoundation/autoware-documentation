# Integrate Autoware with your vehicle
...
![Autoware State Panel](images/integrate-autoware-with-your-vehicle/autoware-state-panel.png){: style="height:360px;width:640px"}
