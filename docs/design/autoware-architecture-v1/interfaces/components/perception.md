...
Please refer to [the perception architecture reference implementation design](../../components/perception/reference_implementation.md) for concepts and data flow.
...
Please refer to [the perception component design](../../components/perception/index.md#high-level-architecture) for detailed definitions of each output."
