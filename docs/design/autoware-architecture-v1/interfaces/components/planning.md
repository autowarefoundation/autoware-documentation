...
This page provides specific specifications about the Interface of the Planning Component. Please refer to the [planning architecture design document](../../components/planning/index.md) for high-level concepts and data flow.
...
This section explains the communication between the different planning modules shown in the [Planning Architecture Design](../../components/planning/index.md#high-level-design).
