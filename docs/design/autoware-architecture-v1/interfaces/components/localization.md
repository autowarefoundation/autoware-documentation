...
The raw 3D-LiDAR data needs to be processed by the [point cloud pre-processing modules](../../components/sensing/data-types/point-cloud.md) before being used for localization.
