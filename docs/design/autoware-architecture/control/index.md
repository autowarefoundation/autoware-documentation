...
This document presents the concept of the vehicle integration policy with respect to Autoware's control. The content is as follows:
...
- Integrate with Vehicle Functions
...
Furthermore, significant differences that affect vehicle motion constraints, such as two-wheel steering or four-wheel steering, are addressed by swithcing the control vehicle model, achieving control specialized for each characteristic.

Autoware's control module outputs the necessary information to control the vehicle as a substitute for a human driver. Therefore, the control commands from the control module would be like the following:
...
| Feathre                                         | Description　                                                                                                                                                            | Requirements/Assumptions                                                          | Note                                                                                                                                                                                                                           | 　Limitation for now                                                                                                                                                       |
| ----------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| Slope Compeneation                              | Supports precise vehicle motion control on slopes                                                                                                                        | Gradient information can be obtained from maps or sensors attached to the chassis | If gradient information is not available, the gradient is estimated from the vehicle's pitch angle.                                                                                                                            |                                                                                                                                                                            |
...
| Steering Deadband Correction                    | Corrects the deadband of the steering to achieve appropriate steering control                                                                                            | The steering deadband parameter is provided in advance                            | If the parameter is unknown, the deadband parameter is estimated from driving information                                                                                                                                      | Not available now                                                                                                                                                          |
| Steering Deadband Estimation                    | Dynamically estimates the steering deadband from driving data                                                                                                            |                                                                                   |                                                                                                                                                                                                                                | Not available now                                                                                                                                                          |
