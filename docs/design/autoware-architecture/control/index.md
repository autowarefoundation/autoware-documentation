...
Furthermore, significant differences that affect vehicle motion constraints, such as two-wheel steering or four-wheel steering, are addressed by swithing the control vehicle model, achieving control specialized for each characteristic.
