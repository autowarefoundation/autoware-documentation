...
- Project Link: [autoware_tensorrt_vad](https://github.com/autowarefoundation/autoware_universe/tree/main/e2e/autoware_tensorrt_vad) (README includes parameters, topics, and model details)
